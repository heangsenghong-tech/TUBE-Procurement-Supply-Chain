...
export interface RequestSummary {
  id: string; number: string; kind: 'purchase' | 'sample'; track: string; status: string; isPettyCash: boolean;
...
export interface RequestDetail {
  id: string; number: string; kind: 'purchase' | 'sample'; track: 'store' | 'hq'; status: string; isPettyCash: boolean;
  ...
  permissions: { canAct: boolean; canCancel: boolean; canResubmit: boolean; canEvaluate: boolean; canReconcile: boolean };
}

export interface InboxEntry { kind: 'request' | 'po'; documentId: string; number: string; title: string; amount: number; stepLabel: string; override: boolean; submittedAt: string; by: string }
...
export interface ReviewGroup {
  ...
  contributors: { lineId: string; requestId: string; requestNumber: string; unitName: string; track: string; requesterName: string; qty: number; requiredDate: string | null; submittedAt: string }[];
}
